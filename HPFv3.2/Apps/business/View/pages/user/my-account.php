<?php
$user = clients::getBy(["cl_id" => $_SESSION["cl_id"]])[0];
...
<div class="tab-content p-y-4">
    <div class="tab-pane fade in active" id="account-profile">
        <div class="row">
            <div class="col-md-8 col-lg-9" id="user-profile">
                <div class="p-x-1">
                    <fieldset class="form-group form-group-lg">
                        <label for="account-name">Name</label>
                        <input type="text" class="form-control name" id="account-name" name="name" placeholder="Mr. " value="<?= $user->cl_name ?>">
                    </fieldset>
                    
                    <fieldset class="form-group form-group-lg">
                        <label for="account-username">Username</label>
                        <input type="text" class="form-control username" id="account-username" name="login" placeholder="Username" value="<?= $user->cl_login ?>">
                        <small class="text-muted">Use for <strong>login</strong> to this vendor panel.</small>
                    </fieldset>
                    
                    <fieldset class="form-group form-group-lg">
                        <label for="account-email">E-mail</label>
                        <input type="email" class="form-control email" id="account-email" name="email" placeholder="Email" value="<?= $user->cl_email ?>">
                        <small class="text-muted">Use for <strong>login & password reset</strong>.</small>
                    </fieldset>
                    
                    <fieldset class="form-group form-group-lg">
                        <label for="account-location">Phone</label>
                        <input type="text" class="form-control phone" name="phone" value="<?= $user->cl_phone ?>" placeholder="01X-XXX XXXX" />
                    </fieldset>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="panel bg-transparent">
                    <div class="panel-body text-xs-center">
                        <img src="<?= PORTAL ?>assets/medias/profiles/<?= empty(UserSetting::detail()->cl_picture) ? "default.png" : UserSetting::detail()->cl_picture ?>" alt="" class="" style="max-width: 100%;">
    ...
    <div class="tab-pane fade" id="account-password">
        <div id="change-password" class="p-x-1">
            <fieldset class="form-group form-group-lg">
