                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">Total (<?php echo Currency::getCode(); ?>)</th>
                            <th class="text-right">Paid (<?php echo Currency::getCode(); ?>)</th>
                            <th class="text-right">Balance (<?php echo Currency::getCode(); ?>)</th>
                        </tr>
                    </thead>
        ...
        data.forEach(function(x){
            ...
            if(x.orders !== undefined){
                x.orders.forEach(function(o){
                    ...
                    if(o.item !== null ){
                        $order += o.item.i_name + " " + o.o_name + " <strong>" + "<?php echo Currency::getCode(); ?>" + " " + o.o_total + "</strong><br />" ;
                    }else{
                        $order += o.o_name + " <strong>" + "<?php echo Currency::getCode(); ?>" + " " + o.o_total + "</strong><br />" ;
                    }
                });
            }
