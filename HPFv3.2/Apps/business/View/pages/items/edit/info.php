		...
		<div class="col-md-10">
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<input class="form-control i-price text-right" type="text" name="price" value="<?php echo number_format($item->i_price, 2)?>" required>
				</div>
				<div class="col-sm-4">
					Category:
				...
				<div class="col-sm-4">
					SKU (Optional):
					<input class="form-control i-sku text-right" type="text" name="sku" value="<?php echo $item->i_sku ?>" required>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-3">
