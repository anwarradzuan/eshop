					...
					switch (url::get(5)){
						case "add_option":
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-1">
										<a class="btn btn-primary bt-bloack" href="<?= PORTAL_BUSINESS ?>items/all-item/edit/<?= url::Get(3) ?>/<?= url::Get(4) ?>">
					    		...
					    		<div id="view_value">
						    		<div class="row row-<?= $no ?>">
						    			<div class="col-sm-6">
						                    <input class="form-control io-value io-value-<?= $no ?>" type="text" name="" value="" data-row="<?= $no ?>" placeholder="Value"><br />
						                </div>
						                <div class="col-sm-3">
						                    <input class="form-control io-price io-price-<?= $no ?>" type="text" name="" value="" data-row="<?= $no ?>" placeholder="Price"><br />
						                </div>
						                <div class="col-sm-3">
							...
							if(count($io) > 0){
								...
								<div class="col-md-12">
						    		...
						    		<div id="view_value">
							    		...
							    		<div class="row row-<?= $no  ?>">
							    			<div class="col-sm-6">
							                    <input class="form-control io-value io-value-<?= $no ?>" type="text" name="" value="<?= $val->iov_value ?>" data-row="<?= $no ?>" data-ivid="<?= $val->iov_id ?>" placeholder="Value"><br />
							                </div>
							                <div class="col-sm-3">
							                    <input class="form-control io-price io-price-<?= $no ?>" type="number" name="" value="<?= $val->iov_price ?>" data-row="<?= $no ?>" data-ivid="<?= $val->iov_id ?>" placeholder="Price"><br />
							                </div>
							                <div class="col-sm-3">
						...
						default:
							?>
							<div class="col-md-2">
								<a class="btn btn-success btn-block" href="<?= PORTAL_BUSINESS ?>items/all-item/edit/<?= url::Get(3) ?>/<?= url::Get(4) ?>/add_option">
									<span class="fa fa-plus"> Add</span>
								</a>
							</div><br /><br />
			...
			window.onload = function(){
				...
				function add_row(){
				    ...
				    <div class="row row-`+ $row_number + `">
				    	<div class="col-sm-6">
				            <input class="form-control io-value io-value-`+ $row_number + `" type="text" name="" value="" data-row="`+ $row_number + `" placeholder="Value" data-ivid="" required><br />
				        </div>
				        <div class="col-sm-3">
