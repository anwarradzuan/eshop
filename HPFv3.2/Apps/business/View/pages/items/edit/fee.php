						...
						if(count($x) > 0){
							...
							<a class="btn btn-primary" href="<?php echo PORTAL ?>items/all-item/edit/<?= url::Get(3) ?>/<?= url::Get(4)?>" >Back</a>
				        		...
				        		<div class="row">
				        			...
				        			<div class="col-sm-6">
				                        Value:
				                        <input class="form-control if-value" type="number" name="if_value" value="<?= $x->if_value ?>" required><br />
				                    </div>
				        		</div>
				        		<div class="row">
				                    <div class="col-sm-12">
					...
					default:
						?>
				    		...
				    		<div class="row">
				    			...
				    			<div class="col-sm-6">
				                    Value:
				                    <input class="form-control if-value" type="number" name="if_value" value="" required><br />
				                </div>
				    		</div>
				    		<div class="row">
				                <div class="col-sm-12 text-center">
