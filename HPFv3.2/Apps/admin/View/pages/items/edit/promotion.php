							...
							if(count($z) > 0){
								...
								<a class="btn btn-primary" href="<?php echo PORTAL ?>items/all-item/edit/<?= url::Get(3) ?>/<?= url::get(4)?>" >Back</a>
				            		...
				            		<div class="row">
				            			...
				            			<div class="col-sm-6">
				                            Value:
				                            <input class="form-control text-right ip-value" type="text" name="ip_value" value="<?= $z->ip_value ?>" required><br />
				                        </div>
				            		</div>
				            		<div class="row">
				                        <div class="col-sm-12">
						...
						default:
							?>
				        		...
				        		<div class="row">
				        			...
				        			<div class="col-sm-6">
				                        Value:
				                        <input class="form-control text-right ip-value" type="text" name="ip_value" value="" required><br />
				                    </div>
				        		</div>
				        		<div class="row">
				                    <div class="col-sm-12">
